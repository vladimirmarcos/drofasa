...
class ConceptoCompraForm(BaseForm):
    def __init__(self, parent_frame):
        ...
        self.headinglist=("id","nombre","iva","siap","cc","ct") 
        self.widthdate=(80,300,200,350,200,200)
        self.headingtext=("Id","Nombre","I.V.A.","Clasificación S.I.A.P.","Cuentas contables","Cuentas Tesorería")
    ...
    def treeviewdata(self):
        for i in self.data:
            ...
            i[5]=self.convertintegretdata("cuentastesoreria","nombre",i[5])
    ...
    def verifnewdata(self):
         if (self.entname.get()=="" or self.entiva.get()=="" or self.entsiap.get()=="" or self.entcc.get()=="" or self.entct.get()==""):
            ...
            message=f'''INSERT INTO conceptocompra (nombre,ivaid,siapid,ccid,ctid) VALUES (?, ?,?,?,?)'''
